...
> 本页为**项目概览**（业务故事 · 架构 · 价值），是快速了解本仓库的「捷径」。
> 想直接动手部署，请看 [上手指南（根目录 README）](../README.md)。

![端到端架构](images/architecture-popmart.png)
...
![Databricks 端到端架构](images/architecture-e2e.png)
...
![Unity Catalog 治理](images/architecture-unity.png)

### 4. 平台 —— Lakeflow 一体化
摄取（Connect）、声明式管道（SDP）、编排（Jobs）与低代码准备（Designer）同属 **Lakeflow**，面向智能体时代的数据平台。

![Lakeflow 平台](images/architecture-lakeflow.png)
...
| 环节 | 文档 |
|---|---|
| 架构总览 | [docs/01-architecture.md](01-architecture.md) |
| 数据生成 | [docs/02-data-generation.md](02-data-generation.md) |
| Auto Loader 摄取 | [docs/03-ingestion-autoloader.md](03-ingestion-autoloader.md) |
| 奖章架构管道 | [docs/04-medallion-pipeline.md](04-medallion-pipeline.md) |
| Genie 智能问答 | [docs/05-genie.md](05-genie.md) |
| AI/BI 仪表板 | [docs/06-dashboard.md](06-dashboard.md) |
| 部署手册 | [docs/07-deploy-runbook.md](07-deploy-runbook.md) |
